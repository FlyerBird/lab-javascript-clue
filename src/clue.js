...
function pickMystery() {
  let randomSupect = suspectsArray[Math.floor(Math.random()*suspectsArray.length)]
  ...
  return {randomSupect, randomRoom, randomWeapon}
}
...
function guess(){
   ...
   if (guessedSuspect === revealMistery.suspect.name 
   && guessedWeapon === revealMistery.weapon.name 
   && guessedRoom === revealMistery.room.name) {
